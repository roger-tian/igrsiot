...
//    @Autowired
//    private IgrsSensorDetailServiceImpl igrsSensorDetailService = new IgrsSensorDetailServiceImpl();
    @Autowired
    public static IIgrsSensorDetailService igrsSensorDetailService;
    @Autowired
    private static IIgrsDeviceStatusService igrsDeviceStatusService;

    public static void cmdHandler(String buff) throws InterruptedException {
        String buf;

        logger.debug("{}-{}", igrsSensorDetailService, igrsDeviceStatusService);
...
//
//            results = buff.split(",");
//            IgrsSensorDetailServiceImpl igrsSensorDetailService1 = new IgrsSensorDetailServiceImpl();
//
//            logger.debug("results.length: {}-{}-{}-{}", results.length, igrsSensorDetailService, igrsDeviceStatusService, igrsSensorDetailService1);
...
//                    igrsSensorDetailService1.insert(igrsSensorDetail);
//                }
