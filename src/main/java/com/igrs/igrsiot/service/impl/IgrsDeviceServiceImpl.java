...
public class IgrsDeviceServiceImpl implements IIgrsDeviceService {
    ...
    @Override
    public List<HashMap<String, String>> getDetailByUserType(HashMap<String, String> map) {
        return igrsDeviceDao.getDetailByUserType(map);
    }

    @Override
    public List<HashMap<String, String>> getDetailByType(HashMap<String, String> map) {
        return igrsDeviceDao.getDetailByType(map);
    }
