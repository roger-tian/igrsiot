...
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(1, 'welcome', '0', '迎宾模式', '0', '', '100', '迎宾模式');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(2, 'machine', '0', '前交互大屏', '0', '192.168.1.200', '100', '交互大屏');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(3, 'machine', '1', '后交互大屏', '0', '192.168.1.200', '100', '交互大屏');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(4, 'led', '0', '智能灯一', '0', '192.168.1.200', '100', '智能灯');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(5, 'led', '1', '智能灯二', '0', '192.168.1.200', '100', '智能灯');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(6, 'curtain', '0', '窗帘', '0', '192.168.1.200', '100', '窗帘');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(7, 'purifier', '0', '净化器', '0', '', '100', '净化器');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(8, 'welcome', '0', '迎宾模式', '0', '', '101', '迎宾模式');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(9, 'machine', '0', '前交互大屏', '0', '192.168.1.199', '101', '交互大屏');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(10, 'machine', '1', '后交互大屏', '0', '192.168.1.199', '101', '交互大屏');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(11, 'led', '0', '智能灯一', '0', '192.168.1.199', '101', '智能灯');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(12, 'led', '1', '智能灯二', '0', '192.168.1.199', '101', '智能灯');
insert into igrs_device(id, type, dindex, name, ctype, cip, room, remark) values(13, 'curtain', '0', '窗帘', '0', '192.168.1.199', '101', '窗帘');
